...
while 1:
    ...
    print("""{}
     ...
     |  _ \    __ _   _ __  | |__     ___          |  ___|  _   _  | | | | |  _ \    ___   __      __   ___   _ __ 
     | | | |  / _` | | '__| | '_ \   / _ \  _____  | |_    | | | | | | | | | |_) |  / _ \  \ \ /\ / /  / _ \ | '__|
     | |_| | | (_| | | |    | |_) | |  __/ |_____| |  _|   | |_| | | | | | |  __/  | (_) |  \ V  V /  |  __/ | |   
     |____/   \__,_| |_|    |_.__/   \___|         |_|      \__,_| |_| |_| |_|      \___/    \_/\_/    \___| |_|   
    
    Sms: {}           {}coded by {}@seker.com\n  
    """.format(Fore.LIGHTCYAN_EX, len(servisler_sms), Style.RESET_ALL, Fore.LIGHTRED_EX))
    try:
        menu = (input(Fore.LIGHTMAGENTA_EX + " 1- SMS Bomber (Nitro)\n\n 2- SMS Bomber (FullPower)\n\n 3- Çıkış\n\n" + Fore.LIGHTYELLOW_EX + " Seçim: "))
        if menu == "":
            continue
        menu = int(menu) 
    except ValueError:
